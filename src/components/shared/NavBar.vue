<template>
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div class="navbar-brand">
        <router-link to="/" class="logo">Estim<span>8</span></router-link>
      </div><!-- navbar-brand -->
      ...
      <div class="navbar-right">
        <div class="dropdown dropdown-profile">
          <a href="" class="dropdown-link" data-toggle="dropdown" data-display="static">
            <div class="avatar avatar-sm"><img src="https://via.placeholder.com/200" class="rounded-circle" alt=""></div>
          </a><!-- dropdown-link -->
          <div class="dropdown-menu dropdown-menu-right tx-13">
            <div class="avatar avatar-lg mg-b-15"><img src="https://via.placeholder.com/200" class="rounded-circle" alt=""></div>
